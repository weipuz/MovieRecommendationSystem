...
public class Weather {
    public static void main(String[] args) throws IOException {
        ...
        HTableDescriptor htd = new HTableDescriptor(
                TableName.valueOf("avahdat_weather"));
        byte[] tablename = htd.getName();
        HTable table = new HTable(config, tablename);
        /*
         * HTableDescriptor htd = new
         * HTableDescriptor(TableName.valueOf("weipuz_test1"));
         * HColumnDescriptor hcd = new HColumnDescriptor("data");
         * htd.addFamily(hcd); admin.createTable(htd); byte [] tablename =
         * htd.getName(); HTableDescriptor [] tables = admin.listTables(); if
         * (tables.length != 1 && Bytes.equals(tablename, tables[0].getName()))
         * { throw new IOException("Failed create of table"); }
         * 
         * // Run some operations -- a put, and a get HTable table = new
         * HTable(config, tablename); byte [] row1 = Bytes.toBytes("row1"); Put
         * p1 = new Put(row1); byte [] databytes = Bytes.toBytes("data");
        ...
        // BinaryComparator(colA));
        SingleColumnValueFilter filter1 = new SingleColumnValueFilter(colfam,
                colA, CompareOp.NOT_EQUAL, fakeValue);
        ...
        for (Result result = sc.next(); (result != null); result = sc.next()) {
            ...
            for (Cell cell : cellsc) {
                ...
                int value = Integer.parseInt(new String(CellUtil
                        .cloneValue(cell)));
                if (value > max) {
                    max = value;
                }
                /*
                 * if(qualifier.equals("SNOW")){ count++;
                 * //System.out.println(qualifier); //System.out.println(count);
                 * int value = Integer.parseInt(new
                 * String(CellUtil.cloneValue(cell)));; if(value >max){ max =
                 * value; } }
                 */
        ...
        /*
         * byte [] row2 = Bytes.toBytes("row2"); Put p2 = new Put(row2);
         * p2.add(databytes, Bytes.toBytes("col1"), Bytes.toBytes("value3"));
         * table.put(p2);
         * 
         * byte [] row3 = Bytes.toBytes("row3"); Put p3 = new Put(row3);
         * p3.add(databytes, Bytes.toBytes("col2"), Bytes.toBytes("value4"));
         * table.put(p3);
         * 
         * // ?? // Write a scan on whole table. // Put your code here // ...
         * 
         * // Drop the table admin.disableTable(tablename);
