...
public class ExtractRatingCount {
	...
	static class RatingMapper extends TableMapper<ImmutableBytesWritable, IntWritable>{
	...
	static class RatingTableReducer extends TableReducer<ImmutableBytesWritable, IntWritable, ImmutableBytesWritable> {
		@Override
